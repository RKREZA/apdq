...
class TransactionTrashesDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($data->onlyTrashed()))
            ...
            ->addColumn('action', function($row){
                if (Gate::check('transaction-delete')) {
                    $restore = '<button class="restore btn btn-sm btn-secondary mb-0 px-2" data-id="'.$row->id.'" data-action="'.route('admin.transactions.restore').'" title="'.__('core::core.form.restore-button').'" data-toggle="tooltip">
                ...
                if (Gate::check('transaction-delete')) {
                    $delete = '<button class="force_destroy btn btn-sm btn-danger mb-0 px-2" data-id="'.$row->id.'" data-action="'.route('admin.transactions.force_destroy').'" title="'.__('core::core.form.delete-button').'" data-toggle="tooltip">
