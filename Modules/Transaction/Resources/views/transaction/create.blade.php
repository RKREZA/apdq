...
@section('page_title')
    {{ __('core::core.create.title', ['name' => __('subscription::subscription.subscription.name')]) }}
@endsection
...
@section('container')
    ...
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'            => __('core::core.create.title', ['name' => __('subscription::subscription.subscription.name')]),
        'include_breadcrumbs'       => [
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="subscription_create_form" action="{{ route('admin.subscriptions.store') }}" method="POST" role="form" autocomplete="off">
                        @csrf()
...
@push('js')
    <script>
        ...
        // Validation
        var validation_id               = "#subscription_create_form";
        var errorElement                = "em";
        var rules                       = {
            title: {
                required: true,
