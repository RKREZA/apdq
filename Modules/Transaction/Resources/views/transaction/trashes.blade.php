...
@section('page_title')
    {{ __('core::core.trashes.title',['name' => __('subscription::subscription.subscription.name')]) }}
@endsection
...
@section('container')
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'        => __('core::core.trashes.title',['name' => __('subscription::subscription.subscription.name')]),
        'include_breadcrumbs'   => [
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        @include('core::layouts.trash_table',[
                            ...
                            'include_restore_all_url'               => route('admin.subscriptions.restore_all'),
                                'include_index_table_data_route'    => route('admin.subscriptions.trashes'),
                                'include_table_rows'                => [
                                    'title'         => __('subscription::subscription.subscription.form.title'),
                                    'description'   => __('subscription::subscription.subscription.form.description'),
