...
class FeedbackCategoriesDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($data))
            ...
            ->addColumn('action', function($row){
                if (Gate::check('feedbackcategory-edit')) {
                    $edit = '<a href="'.route('admin.feedbackcategories.edit', $row->id).'" class="btn btn-sm btn-success mb-0 px-2" title="'.__('core::core.form.edit-button').'" data-toggle="tooltip">
                ...
                if (Gate::check('feedbackcategory-delete')) {
                    $delete = '<button class="remove btn btn-sm btn-danger mb-0 px-2" data-id="'.$row->id.'" data-action="'.route('admin.feedbackcategories.trash').'" title="'.__('core::core.form.trash-button').'" data-toggle="tooltip">
     ...
     *
     * @param \App\FeedbackCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FeedbackCategory $model): QueryBuilder
    {
    ...
    {
        return 'feedbackcategories_' . date('YmdHis');
    }
}
