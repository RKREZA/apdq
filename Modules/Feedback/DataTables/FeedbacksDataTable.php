    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($data))
            ...
            ->addColumn('action', function($row){
                if (Gate::check('feedback-edit')) {
                    $view = '<a href="'.route('admin.feedbacks.view', $row->id).'" class="btn btn-sm btn-success mb-0 px-2" title="'.__('core::core.form.view-button').'" data-toggle="tooltip">
                ...
                if (Gate::check('feedback-delete')) {
                    $delete = '<button class="remove btn btn-sm btn-danger mb-0 px-2" data-id="'.$row->id.'" data-action="'.route('admin.feedbacks.trash').'" title="'.__('core::core.form.trash-button').'" data-toggle="tooltip">
