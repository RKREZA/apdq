...
@section('page_title')
    {{ __('core::core.trashes.title',['name' => __('feedback::feedback.category.name')]) }}
@endsection
...
@section('container')
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'        => __('core::core.trashes.title',['name' => __('feedback::feedback.category.name')]),
        'include_breadcrumbs'   => [
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        @include('core::layouts.trash_table',[
                            ...
                            'include_restore_all_url'               => route('admin.feedbackcategories.restore_all'),
                                'include_index_table_data_route'    => route('admin.feedbackcategories.trashes'),
                                'include_table_rows'                => [
