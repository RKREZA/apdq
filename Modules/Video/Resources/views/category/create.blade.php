...
@section('page_title')
{{ __('core::core.create.title', ['name' => __('video::video.category.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="video_category_add_form" action="{{ route('admin.videocategories.store') }}" method="POST" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.create.title', ['name' => __('video::video.category.name')]),
            'include_breadcrumbs'   => [
