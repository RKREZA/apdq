...
@section('page_title')
{{ __('core::core.edit.title', ['name' => __('video::video.playlist.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="video_playlist_edit_form" action="{{ route('admin.videoplaylists.update', $videoplaylist->id) }}" method="POST" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.edit.title', ['name' => __('video::video.playlist.name')]),
            'include_breadcrumbs'   => [
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group input-group-outline my-2 is-filled @if(old('name')) is-valid @endif @error('name') is-invalid @enderror">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $videoplaylist->name }}">
                            @error('name')
...
<script>
// Validation
var validation_id               = "#video_playlist_edit_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
