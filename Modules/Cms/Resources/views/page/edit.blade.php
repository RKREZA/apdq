...
@section('page_title')
    {{ __('core::core.edit.title', ['name' => __('cms::cms.page.name')]) }}
@endsection
...
@section('container')
    ...
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'            => __('core::core.edit.title', ['name' => __('cms::cms.page.name')]),
        'include_breadcrumbs'       => [
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <form id="page_edit_form" action="{{ route('admin.pages.update', $page->id) }}" method="Page" role="form" autocomplete="off">
                        @csrf()
...
@push('js')
    ...
    <script>
        ...
        // Validation
        var validation_id               = "#page_edit_form";
        var errorElement                = "em";
        var rules                       = {
            title: {
                required: true,
