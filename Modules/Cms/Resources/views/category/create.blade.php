...
@section('page_title')
{{ __('core::core.create.title', ['name' => __('cms::cms.category.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="page_category_add_form" action="{{ route('admin.pagecategories.store') }}" method="Page" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.create.title', ['name' => __('cms::cms.category.name')]),
            'include_breadcrumbs'   => [
...
<script>
// Validation
var validation_id               = "#page_category_add_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
