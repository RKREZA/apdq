...
<head>
    ...
    <title>This is huge: Save $50 on Versa 2 now</title>
...
<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#f5f5f5; -webkit-text-size-adjust:none;">
    <table border="0" cellpadding="0" cellspacing="0" style="border:1px solid #ccc; border-radius: 10px; width: 80%;margin: 50px 10%;border:none;border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;" class="wrapper" bgcolor="#4fb66d">
        <tr>
            <td style="padding: 15px;">
                <img src="{{ asset('assets/backend/img/logo-light.png') }}" class="" style="height: 100px;">
            </td>
            <td style="text-align: right; padding: 15px;">
                <img src="{{ asset('assets/backend/img/bangladesh_government.png') }}" style="height: 90px; text-align: right">
            </td>
        </tr>
        ...
        <tr bgcolor="#fff">
            <td colspan="2" style="padding: 25px;">
                <h2>{{ $title }} - ({{ $status }})</h2>
                {!! $description !!}
                <a href="{{ $actionUrl }}" style="border-radius:25px; padding: 13px 30px; background:#113938;color:#fff; margin-top: 15px; display:inline-block">{{ $actionText }}</a>
            </td>
        </tr>
    </table>
</body>
