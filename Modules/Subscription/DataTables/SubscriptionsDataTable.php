    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($data))
            ...
            ->addColumn('action', function($row){
                if (Gate::check('subscription-edit')) {
                    $edit = '<a href="'.route('admin.subscriptions.edit', $row->id).'" class="btn btn-sm btn-success mb-0 px-2" title="'.__('core::core.form.edit-button').'" data-toggle="tooltip">
