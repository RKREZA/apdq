...
@section('page_title')
{{ __('core::core.create.title', ['name' => __('blog::blog.subcategory.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="post_category_add_form" action="{{ route('admin.postsubcategories.store') }}" method="POST" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.create.title', ['name' => __('blog::blog.subcategory.name')]),
            'include_breadcrumbs'   => [
...
<script>
// Validation
var validation_id               = "#post_category_add_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
