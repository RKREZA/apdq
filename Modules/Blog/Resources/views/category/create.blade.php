...
@section('page_title')
{{ __('core::core.create.title', ['name' => __('blog::blog.category.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="post_category_add_form" action="{{ route('admin.postcategories.store') }}" method="POST" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.create.title', ['name' => __('blog::blog.category.name')]),
            'include_breadcrumbs'   => [
