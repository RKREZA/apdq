...
@section('page_title')
{{ __('core::core.edit.title', ['name' => __('user::permission.name')]) }}
@endsection
...
@section('container')
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'            => __('core::core.edit.title', ['name' => __('user::permission.name')]),
        'include_breadcrumbs'       => [
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <form id="permission_edit_form" action="{{ route('admin.permissions.update', $permission->id) }}" method="POST" role="form" autocomplete="off">
                    @csrf()
