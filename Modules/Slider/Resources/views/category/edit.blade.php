...
@section('page_title')
{{ __('core::core.edit.title', ['name' => __('slider::slider.category.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="slider_category_edit_form" action="{{ route('admin.slidercategories.update', $slidercategory->id) }}" method="post" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.edit.title', ['name' => __('slider::slider.category.name')]),
            'include_breadcrumbs'   => [
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group input-group-outline my-2 is-filled @if(old('name')) is-valid @endif @error('name') is-invalid @enderror">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $slidercategory->name }}">
                            @error('name')
                    ...
                    <div class="col-md-12">
                        <div class="input-group input-group-outline my-2 is-filled @if(old('code')) is-valid @endif @error('code') is-invalid @enderror">
                            ...
                            <input type="text" name="code" class="form-control" value="{{ $slidercategory->code }}">
                            @error('code')
                                <em class="error invalid-slider" style="display: inline-block;">{{ $message }}</em>
                            @enderror
                        </div>
...
<script>
// Validation
var validation_id               = "#slider_category_edit_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
