...
@section('title')
Les plus récentes Vidéo
@endsection
@section('seo')
    <meta name="title" content="Les plus récentes Vidéo">
    <meta name="description" content="{{ $frontend_setting->meta_description }}">
    <meta name="keywords" content="{{ $frontend_setting->meta_keywords }}">

    <meta property="og:title" content="Les plus récentes Vidéo" />
        ...
        <div class="row">
            <div class="col-md-10 mb-4">
                <h5 class="m-0 text-light">
                    ...
                    <i class="fi fi-sr-angle-small-right" style="position: relative; top:3px;"></i> Les plus récentes Vidéo
                </h5>
            </div>
        </div>
