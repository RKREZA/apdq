    ...
    <div class="container py-5">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-5 wow slideInRight">
                ...
                border-radius: 30px;
                background: #ccc;
                padding-top: 30px;" src="{{ asset('assets/frontend/img/person5.webp') }}" alt="">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-3 mt-3 wow bounceInUp">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold mt-3">Le Catalyseur de Conscience</h5>
                        <p class="small">Éveiller l'action face à l'adversité collective.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mt-3 wow bounceInUp">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold mt-3">Le Pulsar Politique</h5>
                        <p class="small">Revitaliser l'Engagement Politique avec Humour et Perspicacité</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mt-3 wow bounceInUp">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold mt-3">Piliers de la Mission</h5>
                        <p class="small">Défendre la Justice, les Droits, et le Respect pour un Avenir Meilleur.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mt-3 wow bounceInUp">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold mt-3">Renforcer APDQ</h5>
                        <p class="small">Unis pour le Changement, Soutenez la Cause – Redéfinissons la Politique.</p>
                    </div>
                </div>
            </div>
        </div>
