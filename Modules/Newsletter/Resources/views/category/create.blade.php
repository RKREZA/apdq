...
@section('page_title')
{{ __('core::core.create.title', ['name' => __('newsletter::newsletter.category.name')]) }}
@endsection
...
@section('container')
    ...
    <form id="newsletter_category_add_form" action="{{ route('admin.newslettercategories.store') }}" method="POST" role="form" autocomplete="off">
        @csrf()
        ...
        @include('core::layouts.sticky_page_header', [
            ...
            //     ],
            // ],
            'include_header'        => __('core::core.create.title', ['name' => __('newsletter::newsletter.category.name')]),
            'include_breadcrumbs'   => [
...
<script>
// Validation
var validation_id               = "#newsletter_category_add_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
