...
@section('page_title')
    {{ __('core::core.edit.title', ['name' => __('stoppage::stoppage.name')]) }}
@endsection
...
@section('container')
    ...
    @include('core::layouts.sticky_page_header', [
        ...
        'include_header'            => __('core::core.edit.title', ['name' => __('stoppage::stoppage.name')]),
        'include_breadcrumbs'       => [
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <form id="stoppage_edit_form" action="{{ route('admin.stoppages.update', $stoppage->id) }}" method="POST" role="form" autocomplete="off">
                        @csrf()
...
@push('js')
    ...
    <script>
        ...
        // Validation
        var validation_id               = "#stoppage_edit_form";
        var errorElement                = "em";
        var rules                       = {
            name: {
                required: true,
